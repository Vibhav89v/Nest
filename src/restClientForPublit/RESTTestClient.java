...
public class RESTTestClient {
	...
	public static void main(String[] args) 
	{
		...
		String URL="https://api.publit.com/trade/v2.0/products?only=isbn,updated_at&updated_at=2017-06-30&updated_at_args=greater_equal;combinator";
		...
		*/
	    PublitVO vo=Isbn.getIsbnFrPublit(URL,userid, password);    
		//Isbn.getIsbnFrPublit(URL,userid, password);
	}
