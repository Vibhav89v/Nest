...
public class MongoDBMorphia implements AutomationConstants
{
	private static MongoClient mongoClient;
	private  String user = "";
	private  String password = "";
	private  String proddatabase = "nextory";
	private  String logdatabase ="nest_ver2";
	private  String authDatabases="nlob,nest_ver2,e2go_old,mongoui,nextory";
...
/*	public AggregateIterable<Document> aggregate(NestAggregationPipeLine pipeline){
	...
	//----------------------------------------------Nest_ver2------------------------------------------------------------
	public Datastore getMorphiaDatastoreForNestVer2()
	{
		return getMorphiaDatastore(logdatabase);
	}
