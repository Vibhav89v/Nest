...
public class DetailsOfActiveISBNNest extends SuperTestScript implements AutomationConstants
{
		...
		for(int i=0;i<isbnList.size();i++)
		{
			...
			log.info("ISBN "+(i+1)+" = " +isbnList.get(i));
	         ...
	         while( prodCursor.hasNext() )
	         {
	           ...
	           log.info("'DISTRIBUTOR NAME' IN PRODUCT COLLECTION : "+mobj1.get("distributorname"));
